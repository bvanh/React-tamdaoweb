  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Danhsachhotel, [{
    ...
    value: function render() {
      ...
      var danhsach = this.state.items.filter(function (fil) {
        return fil.ten.toLowerCase().split(' ').join('').indexOf(_this2.state.search.toLowerCase().split(' ').join('')) !== -1;
      });
...
//# sourceMappingURL=dichvu.js.00e6696ea5f5633c911c.hot-update.js.map