...
function Rating(props) {
  ...
  for (var _i = 0; _i < props.value; _i++) {
    rater.push(__jsx("i", {
      key: _i,
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Danhsachhotel, [{
    key: "filterRate",
    value: function filterRate(i, e) {
      if (e) {
        var newItems = this.state.items.filter(function (item) {
          return item.danhgia >= i;
        });
        this.setState({
          items: newItems
        });
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        filterRate: function filterRate() {
          return _this2.filterRate(i, e);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 66
...
//# sourceMappingURL=dichvu.js.fd0499e9b72490c8fb94.hot-update.js.map