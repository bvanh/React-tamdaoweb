    ...
    return(
        ...
        <div className="row footer">
            ...
            <div className="col-sm-2 p-0 icon-media">
                <a className="nav-link link-media" href="#"><img src="static/img/facebook.png" className="icon-media" /><img src="static/img/instagram.png" className="icon-media" /><img src="static/img/twitter.png" className="icon-media" /></a>
            </div>
        </div>
    </footer>
    )
